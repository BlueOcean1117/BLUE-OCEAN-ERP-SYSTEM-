  ...
  <div className="step-form">
    ...
    <div className="form-grid">
      ...
      <div className="field">
        ...
        <input className="input" name="ff" value={form.ff} onChange={change} />
      </div>
    </div>
    ...
    <div className="form-grid">
      ...
      <div className="field">
        ...
        <input className="input" type="date" name="dispatch_date" value={form.dispatch_date} onChange={change} />
      </div>
    </div>
    ...
    <div className="form-grid">
      <div className="field full">
        <label>Part No</label>
        <input className="input" name="part_no" value={form.part_no} onChange={change} />
      </div>
    </div>
...
/>
    ...
    <div className="form-grid">
      <div className="field">
        ...
        <input className="input" name="part_net_wt" value={form.part_net_wt} onChange={change} />
      </div>

      <div className="field">
        <label>Quantity</label>
        <input className="input" name="part_qty" value={form.part_qty} onChange={change} />
      </div>
    </div>
    ...
    <div className="form-grid">
      <div className="field">
        ...
        <input className="input" name="packaging_wt" value={form.packaging_wt} onChange={change} />
      </div>

      <div className="field">
        <label>Gross Weight</label>
        <input className="input" name="gross_wt" value={form.gross_wt} onChange={change} />
      </div>
    </div>
    ...
    <div className="form-grid">
      ...
      <div className="field">
        ...
        <input className="input" name="box_size" value={form.box_size} onChange={change} />
      </div>
    </div>
    ...
    <div className="form-grid">
      <div className="field">
        ...
        <input className="input" name="package_type" value={form.package_type} onChange={change} />
      </div>
